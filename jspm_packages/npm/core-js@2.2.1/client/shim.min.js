...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var q = b(2),
          ...
          z = q.QObject,
          A = t && J(function() {
            return 7 != l(g({}, "a", {get: function() {
                return g(this, "a", {value: 7}).a;
              }})).a;
          }) ? function(c, a, d) {
            var b = T(k, a);
            b && delete k[a], g(c, a, d), b && c !== k && g(k, a, b);
          } : g,
          S = function(a) {
            var b = i[a] = l(c[h]);
            return b._k = a, t && m && A(k, a, {
              configurable: !0,
              set: function(b) {
                e(this, d) && e(this[d], a) && (this[d][a] = !1), A(this, a, u(1, b));
              }
            }), b;
          },
          B = j && "symbol" == typeof c.iterator ? function(a) {
            return "symbol" == typeof a;
          } : function(a) {
            return a instanceof c;
          },
          C = function defineProperty(a, b, c) {
            return v(a), b = y(b, !0), v(c), e(i, b) ? (c.enumerable ? (e(a, d) && a[d][b] && (a[d][b] = !1), c = l(c, {enumerable: u(0, !1)})) : (e(a, d) || g(a, d, u(1, {})), a[d][b] = !0), A(a, b, c)) : g(a, b, c);
          },
          V = function defineProperties(a, b) {
            v(a);
            for (var c,
                d = $(b = n(b)),
                e = 0,
          ...
          X = function create(b, c) {
            return c === a ? l(b) : V(l(b), c);
          },
          L = function propertyIsEnumerable(a) {
            var b = aa.call(this, a = y(a, !0));
            return b || !e(this, a) || !e(i, a) || e(this, d) && this[d][a] ? b : !0;
          },
          E = function getOwnPropertyDescriptor(a, b) {
            var c = T(a = n(a), b = y(b, !0));
            return !c || !e(i, b) || e(a, d) && a[d][b] || (c.enumerable = !0), c;
          },
          ...
          G = function getOwnPropertySymbols(f) {
            for (var a,
                ...
                c = [],
                d = 0; b.length > d; )
              e(i, a = b[d++]) && c.push(i[a]);
            return c;
          },
          _ = function stringify(e) {
            if (e !== a && !B(e)) {
              for (var b,
                  c,
                  d = [e],
                ...
                d.push(arguments[f++]);
              return b = d[1], "function" == typeof b && (c = b), !c && Z(b) || (b = function(b, a) {
                return c && (a = c.call(this, b, a)), B(a) ? void 0 : a;
              }), d[1] = b, p.apply(o, d);
            }
          },
          W = J(function() {
      ...
      j || (c = function Symbol() {
        ...
        return S(ca(arguments.length > 0 ? arguments[0] : a));
      }, U(c[h], "toString", function toString() {
        return this._k;
      }), Q.f = E, R.f = C, b(45).f = P.f = H, b(39).f = L, b(38).f = G, t && !b(47) && U(k, "propertyIsEnumerable", L, !0)), f(f.G + f.W + f.F * !j, {Symbol: c});
      for (var F = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),
        ...
        var w = F[O++],
            I = Y.Symbol,
            N = s(w);
        w in I || g(I, w, {value: j ? N : S(N)});
      }
      z && z[h] && z[h].findChild || (m = !0), f(f.S + f.F * !j, "Symbol", {
        "for": function(a) {
      ...
      }), o && f(f.S + f.F * (!j || W), "JSON", {stringify: _}), c[h][K] || b(8)(c[h], K, c[h].valueOf), x(c, "Symbol"), x(Math, "Math", !0), x(q.JSON, "JSON", !0);
    }, function(a, d) {
      ...
      if (l)
        ...
        new k(d).observe(j, {characterData: !0}), f = function() {
          j.data = m = !m;
        };
      } else
        f = i && i.resolve ? function() {
          i.resolve().then(d);
        } : function() {
          o.call(c, d);
        };
 ...
 while (!((c = d[b._i++]) in b._t));
      ...
      var a = b(7);
      a(a.G + a.W + a.F * !b(228).ABV, {DataView: b(229).DataView});
    }, function(b, c, a) {
      a(232)("Int8", 1, function(a) {
      ...
      a(135)(c, "RegExp String", function next() {
      ...
      var b = a(7),
          ...
          d = a(19),
          e = a(9);
      a(5) && b(b.P + a(255), "Object", {__defineGetter__: function __defineGetter__(a, b) {
          e.f(c(this), a, {
            get: d(b),
            enumerable: !0,
            configurable: !0
      ...
      var b = a(7),
          ...
          d = a(19),
          e = a(9);
      a(5) && b(b.P + a(255), "Object", {__defineSetter__: function __defineSetter__(a, b) {
          e.f(c(this), a, {
            set: d(b),
            enumerable: !0,
            configurable: !0
      ...
      var b = a(7),
          ...
          e = a(55),
          f = a(46).f;
      a(5) && b(b.P + a(255), "Object", {__lookupGetter__: function __lookupGetter__(g) {
          var b,
              a = c(this),
              h = d(g, !0);
          do
 ...
 while (a = e(a));
      ...
      var b = a(7),
          ...
          e = a(55),
          f = a(46).f;
      a(5) && b(b.P + a(255), "Object", {__lookupSetter__: function __lookupSetter__(g) {
          var b,
              a = c(this),
              h = d(g, !0);
          do
 ...
 while (a = e(a));
      ...
      var a = b(7);
      a(a.P + a.R, "Map", {toJSON: b(260)("Map")});
    }, function(b, e, a) {
      var c = a(71),
          d = a(261);
      b.exports = function(a) {
      ...
      var a = b(7);
      a(a.P + a.R, "Set", {toJSON: b(260)("Set")});
    }, function(c, d, a) {
      var b = a(7);
